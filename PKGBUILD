...
# based on the original https://git.archlinux.org/svntogit/packages.git/tree/trunk?h=packages/gvfs
# 						Maintainer: Jan de Groot <jgc@archlinux.org>

pkgbase=gvfs
pkgname=(gvfs gvfs-{smb,afc,gphoto2,goa,mtp,nfs,google})
pkgver=pkgver=1.32.1+5+gf0d758df
pkgrel=2
...
groups=(gnome)
_commit=f0d758dff4cdddf11535bfb96bc2a15d65cfe80f # gnome-3-24
